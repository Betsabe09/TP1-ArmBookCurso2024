...
\fi
  % Hyperlinks
    ...
    \hypersetup{%
      ...
      citecolor=blue,%
      unicode,%
      pdftitle={Módulo USER-\/\+CONTROL},%
      pdfsubject={Manejo del módulo de control del sistema de seguridad que tendrá el usuario del vehículo}%
    }
